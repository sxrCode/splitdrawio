...
Actions.prototype.init = function()
{
	...
	this.addAction('save', function() {console.log('execute save action!'); ui.saveFile(false); console.log('ui.saveFile!');}, null, null, Editor.ctrlKey + '+S').isEnabled = isGraphEnabled;

...
StyleFormatPanel.prototype.init = function () {
	...
	var ap = this.createRelativeOption(mxResources.get('textOpacity'), mxConstants.STYLE_TEXT_OPACITY, 41);
	ap.style.paddingTop = '8px';
	ap.style.paddingBottom = '8px';
...
DiagramFormatPanel.prototype.init = function () {
	...
	if (graph.isEnabled()) {
		...
		this.container.appendChild(this.addCustomViewTo(this.createPanel()));
	}
};

/**
 * Adds a custom View to the given parent div
 */
DiagramFormatPanel.prototype.addCustomViewTo = function (div) {
	var ui = this.editorUi;
	var editor = ui.editor;
	var graph = editor.graph;

	div.appendChild(this.createTitle("Custom View"));
